...
- **Decision-making under uncertainty:** Each query point commits to an action/decision based on incomplete information; decision strategies include exploration vs. exploitation, model-driven vs. human-override.
